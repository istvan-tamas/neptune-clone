...
public class ShowAllStudentController implements Initializable {
    ...
    private final ObservableList<Student> studentModels = FXCollections.observableArrayList(studentController.getAllStudents());
